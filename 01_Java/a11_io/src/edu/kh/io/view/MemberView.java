...
public class MemberView {
	...
	public void displayMenu() { 
		...
		do {
			try {
				...
				case 4 : modifyPw(); break;
				case 5 : removeOne(); break;
	...
	private void modifyPw() {
		...
		boolean result = service.modifyPw(id, pw);
	...
	private void removeOne() {
		...
		boolean result = service.removeOne(id, pw);
