...
public class LoopEx3 {
	...
	// 예제 1 - 숫자 0이 입력될 때까지 프로그램 종료 X
	public void ex1() {
		
		Scanner sc = new Scanner(System.in);
		
		int input = -1; // 입력 받은 값을 저장할 변수 + 종료 조건과 관련 없는 값으로 초기화
	...
	// 예제 2 - 숫자 0이 입력될 때까지 프로그램 종료 X
	// + 0이 입력되기 전까지 입력된 모든 숫자의 합 출력
	public void ex2() {
		
		Scanner sc = new Scanner(System.in);
		
		int input = -1; // 입력 값 저장 + while 문이 종료되지 않게 하는 값 대입
		int sum = 0;
	...
	// 예제 5 - do-while 문 : while문의 조건식 확인 위치를 끝으로 보낸 while문
	public void ex5() {
		...
		while(input!=0);
		// do 구문에서 input이 무조건 초기화되기 때문에
		// iput 선언 시 초기화를 하지 않아도
