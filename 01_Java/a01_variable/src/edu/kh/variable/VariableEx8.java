...
public class VariableEx8 {
	...
	public static void main(String[] args) {
		...
		// (int)300 + (daouble) 12.3
		// (double) 300.0 + (dpouble)12.3 == (double)312.3
		...
		// 실수 -> 정수 강제 형변환 시 소수점 아래 버림(데이터 손실)
		...
		// 강제 형변환 확인 4 : 원하는 자료형으로 변경 / 데이터 손실x
		int test7 = 123;
