...
public class StudentService {
	...
	public StudentService() {
		...
		studentList.add(new Student(2, 1, 16, "김갑순", 'F', 80));
		studentList.add(new Student(2, 2, 7, "도레미", 'F', 90));
		studentList.add(new Student(6, 8, 35, "이흥부", 'M', 50));
		studentList.add(new Student(1, 6, 3, "김갑돌", 'M', 30));
	}
	...
	public boolean duplicateValidation(int grade, int ban, int number, String name, char gender, int score) {
		...
		// * contains 사용 전제 조건 *	
		// 비교하려는 객체(클래스)에 Object의 equals가
		// 오버라이딩 되어있어야 한다!
