...
// Comparable<Student> 인터페이스 -> Student 객체 정렬 기준을 정하기 위한 기능 
...
public class Student implements Comparable<Student> {
	...
	// (중요!) equals()를 오버라이딩 했으면 hashCode()도 오버라이딩 해야한다!!
	
	// hashCode() : 해시 테이블(객체 주소록)에서 객체를 빨리 찾아가게 하기위한 번호
