...
public class RaceRun {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// main이 여기서 대기해야함
			// Thread.join()
			// - 지정된 스레드(th1,th2)가 끝날 때까지 현재 스레드(main) 대기시킴
			th1.join();
			th2.join();
	...
	} // th1, th2 일하는 중 main 대기
	// -> th1, th2 끝나기 전에 승패여부 출력 먼저 끝나버리는 것
	// th1 0~11초, th2 0.5~11.5초 동작-> main 종료
	
	
	// 콘솔창 클리어(엔터 많이 하기)
	public static void clear() {
		// StrignBuffer : String 불변성 문제를 해결한 객체
