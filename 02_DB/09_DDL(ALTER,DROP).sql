...
-- ALTER(바꾸다, 변조하다)
-- 수정 가능한 것 : 컬럼(추가/수정(자료형,기본값 바꾸는 것)/삭제), 제약조건(추가/삭제)
--                  이름변경(테이블, 컬럼, 제약조건)
...
DEPT_ID CONSTRAINT SYS_C0014059 NULL; -- DEPT_ID NOT NULL 제거

ALTER TABLE DEPT_COPY MODIFY
LOCATION_ID CONSTRAINT SYS_C0014060 NULL; -- LOCATION_ID NOT NULL 제거

ALTER TABLE DEPT_COPY MODIFY
DEPT_TITLE CONSTRAINT SYS_C0014116 NULL; -- DEPT_TITLE NOT NULL 제거
...
--> 기본값을 바꾼것. 컬럼내용 바꾼거 아님

-- LNAME 컬럽 값을 모두 '대한민국' 변경(DEFAULT 사용)
