...
--TO_CHAR(SYSDATE,'YYYYMMDD') - ('19' ||SUBSTR(PROFESSOR_SSN,1,6)) 나이
FROM TB_PROFESSOR
...
-- 정석방법: WHERE EXTRACT(YEAR FROM ENTRANCE_DATE) 
--				- EXTRACT(TO_DATE('19'||SUBSTR(STUDENT_SSN, 1, 6),'YYYYMMDD')) > 19;
