...
SELECT DEPT_CODE, SUM(SALARY) FROM EMPLOYEE; -- 테이블 모양이 아니어서 오류
...
-- 부서코드가 'D5' 이면서 급여가 300만 초과하는 사원의 이름, 부서코드, 급여 조회
...
-- 부서코드가 'D5' 이거나 급여가 300만 초과하는 사원의 이름, 부서코드, 급여 조회 (중복 포함)
...
-- EMP_NAME, PHONE : 문자, SALARY,1000000 : 숫자
