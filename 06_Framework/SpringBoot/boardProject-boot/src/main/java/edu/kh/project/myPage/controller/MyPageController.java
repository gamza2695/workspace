...
public class MyPageController {
	 ...
	 * @param loginMember : 현재 로그인한 회원의 정보가 담긴 객체(session에서 얻어옴)
	...
	public String info(Member updateMember, String[] memberAddress,
		...
		updateMember.setMemberNo(loginMember.getMemberNo()); // 로긴멤버에서 얻어온 멤버넘버를 업데이트멤버에 세팅
...
// =>	int result = service.secession(memberPw, loginMember.getMemberNo());
	...
	// MultipartFile : mulipart/form-data 형식으로 제출된 파라미터 중
