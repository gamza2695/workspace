...
public class BeforeAspect {
	...
	// -> edu.kh.project 패키지 내부에 Controller라고 하는 이름이 포함된 클래스의
	...
	public void beforeLog(JoinPoint jp) {
		...
		try {
			HttpServletRequest req = ((ServletRequestAttributes) RequestContextHolder.currentRequestAttributes()).getRequest();	// 컨트롤러가 아니어서 IP 얻어오는 게 복잡
