...
public class AjaxController {
	...
	@ResponseBody // forward 아니고 값 자체 반환(비동기)
	...
	public int insertMember(@RequestBody Member member) { // @RequestBody 키 값이 dto랑 같아서 member 사용가능
