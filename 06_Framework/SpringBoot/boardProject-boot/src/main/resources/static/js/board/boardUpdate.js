...
// x 버튼이 클릭도니 input 태그의 순서를 기록할 Set 생성
// (Set의 특징 : 순서x, 중복허용 x => x버튼 여러번 눌러도 하나만 추가)
...
/* 이미지 선택 시 수행할 함수 */
const chagneImageFn = (imageInput, order) => {
  ...
  // log 찍어보면 선택후 다시 취소누르면 undefined
  if(uploadFile == undefined){
    ...
    imageInput.addEventListener("change", () => {
      chagneImageFn(imageInput, order);
    });
