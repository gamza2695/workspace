...
public class OpenApiController {
	...
	public String ex2(Model model, 
		...
		// 인증키
		final String serviceKey = "9fK%2B0CshYfva2kdfAOMhpvJGQe4gZq7sUi%2FgC2BTloknSLv5YClWBa0%2FzisXsJzIhNIYClZMCgOOExDT%2F%2FtNvw%3D%3D";
		...
		// JSONObject : Sprgin Boot에서 제공하는 JSON 다루기 용도의 객체
		...
		// ObjectMapper : Jackson 라이브러리에서 제공하는 객체 (많이 써서 자바 제공)
		//				  JSON 데이터를 Java 객체로 변환하는 객체
		ObjectMapper om = new ObjectMapper();
		
		// item 변수에 담긴 JSON 데이터 하나하나를 Map으로 변경한 후 List에 추가 
