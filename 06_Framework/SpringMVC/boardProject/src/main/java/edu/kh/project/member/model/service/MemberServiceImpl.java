...
public class MemberServiceImpl implements MemberService {
	...
	public Member login(Member inputMember) {
		...
		// 1) 암호화 확인
		// 2) 같은 비밀번호 입력 시 암호화된 값이 다른지 확인	
//		String tmp = bcrypt.encode(inputMember.getMemberPw());
//		System.out.println("입력된 비밀번호 : " + inputMember.getMemberPw() );
//		System.out.println("암호화된 비밀번호 : " + tmp);
		...
		// 현재 클래스가 Bean으로 등록되어 의존성 주입되었나 확인
	...
	// [주의 사항]
	// servlet-context.xml에 tx:annotation-drive 태그가 존재해야 한다.
