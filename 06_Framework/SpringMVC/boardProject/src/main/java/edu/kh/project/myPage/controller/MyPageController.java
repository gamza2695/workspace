...
@SessionAttributes({"loginMember"})  // session에 올리기도 하고 가져오기도 함
...
public class MyPageController {
	...
	/** 회원 정보 수정
	 * @param updateMember : 수정된 회원 정보과 담긴 커맨드 객체
	...
	public String info(Member updateMember
			...
			//	Member가 loginMember 매개변수에 대입(주입)
	...
	public String changePw(
			/*@RequestParam("currentPw") 똑같아서 생략가능*/ String currentPw,
			String newPw,
			@SessionAttribute("loginMember") Member loginMember,
			RedirectAttributes ra) {
