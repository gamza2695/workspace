...
-- 계정 생성
CREATE USER spring_jyj IDENTIFIED BY spring1234;

-- 권한 부여
GRANT CONNECT, RESOURCE, CREATE VIEW TO spring_jyj;

-- 객체 생성 공간 할당
ALTER USER spring_jyj DEFAULT TABLESPACE "A230724"
...
-- 샘플 계정 추가
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'member01@naver.com', 'pass01', '회원01','01012341234'
...
-- 글 1500개 각 게시판(3개) 랜덤으로 몇개씩 들어갔는지 조회
SELECT COUNT(*) FROM "BOARD"
WHERE BOARD_CODE = 1;


-- COMMENT 테이블 샘플 데이터 삽입(PL/SQL)
-- 1 : 300 , 4: 400, 5: 500, 9: 300
BEGIN
   FOR I IN 1..300 LOOP
      INSERT INTO "COMMENT" 
      VALUES(SEQ_COMMENT_NO.NEXTVAL, 
            ...
            DEFAULT, DEFAULT,
            9, CEIL(DBMS_RANDOM.VALUE(0,1500)), NULL);
   END LOOP;
END;
...
/* 게시글 좋아요 샘플데이터 */
INSERT INTO "BOARD_LIKE" VALUES(5,1499);
INSERT INTO "BOARD_LIKE" VALUES(1,1273);
INSERT INTO "BOARD_LIKE" VALUES(4,1366);
INSERT INTO "BOARD_LIKE" VALUES(9,1295);
INSERT INTO "BOARD_LIKE" VALUES(1,1500);

COMMIT;
SELECT BOARD_CODE FROM "BOARD" WHERE BOARD_NO = 100;
...
SELECT BOARD_NO, BOARD_TITLE, READ_COUNT, MEMBER_NICKNAME, 
	...
	(SELECT IMG_PATH || IMG_RENAME FROM BOARD_IMG I
   	...
   	AND IMG_ORDER = 0) THUMBNAIL -- 0번째 제일 앞에 있는 이미지 
...
SELECT NEXT_IMG_NO(), '경로', '변경된이름', '원본이름', 0, 1498 FROM DUAL
UNION
SELECT NEXT_IMG_NO(), '경로2', '변경된이름2', '원본이름2', 2, 1498 FROM DUAL
UNION
SELECT NEXT_IMG_NO(), '경로3', '변경된이름3', '원본이름3', 3, 1498 FROM DUAL;
...
JOIN "MEMBER" USING (MEMBER_NO)
WHERE BOARD_DEL_FL = 'N'
AND BOARD_CODE =  1/*#{boardCode}*/
-- AND BOARD_TITLE LIKE '%12%' /*제목*/
-- AND BOARD_CONTENT LIKE '%12%' /*내용*/
-- AND (BOARD_TITLE LIKE '%12%' OR BOARD_CONTENT LIKE '%12%')/*제목 + 내용 (AND>OR 우선순위 높다!)*/
-- AND MEMBER_NICKNAME LIKE '%회%'/*작성자(닉네임)*/
ORDER BY BOARD_NO DESC;
