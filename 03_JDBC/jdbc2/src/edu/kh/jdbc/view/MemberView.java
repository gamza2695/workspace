...
//		member.setMemberPw(pw);
	...
	private void updatePw() {
		...
		member2.setMemberPw(newPw);
		
		int result = service.updatePw(member, member2);
		
		if(result > 0) System.out.println("비밀번호 수정 완료!");
		else System.out.println("아이디 또는 비밀번호 불일치");
	}
