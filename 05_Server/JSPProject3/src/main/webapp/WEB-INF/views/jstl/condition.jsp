...
<body>
  ...
  <pre>
    ...
    ** test 속성값 작성 시 주의사항 **
    ...
    1) 속성값은 무조건 EL 구문으로 작성해야 된다!!
        test = "\${key == 123}"

    2) 속성값은 무조건 true/false가 최종 결과로 나와야한다
   
    3) 속성값을 작성하는 "" 제일 앞/뒤에는 띄어쓰기가 있으면 안된다!!

        오류예시 : test = "  \${key == 123}" // 앞에 공백
        오류예시 : test = "\${key == 123}  " // 뒤에 공백
  ...
  <hr>
  <h1>2. 연속 조건문 (c:choose / c:when / c:otherwise)</h1>
