...
function idTest(){
  ...
  // Java에서 배열 리터럴 표기법 : {}
  // Js에서 배열 리터럴 표기법 : []
  const colorArray = ['red',"yellow",'green','purple','beige','pink'];
...
function classTest(){
  ...
  arr[1].style.backgroundColor = "rgb(25,86,165)";
  arr[1].innerText = "arr[1]입니다";

  arr[2].style.backgroundColor = "rgb(135,68,200)";
...
function tagTest(){
  ...
  for(let i=0; i<arr.length; i++){
    arr[i].style.backgroundColor = "rgb(255, 200, "+ arr[i].innerText +")";
  }
