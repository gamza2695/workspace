...
document.getElementById("btn1").addEventListener("click", () => {
  ...
  // ---------------------------------------------
  // 2) append("내용" 또는 노드 또는 요소) : 마지막 자식 내용/노드/요소로 추가
  ...
  // ---------------------------------------------
  // 3) prepand("내용" 또는 노드 또는 요소) : 첫번째 자식으로 내용/노드/요소로 추가
  // + 매개변수로 여러 값을 작성해 한번에 추가 가능
...
btn2.addEventListener("click", () => {
  ...
  // #test2를 기준으로 body태그의 첫번째 자식 요소 선택
...
/* innerHTML / DOM 요소 생성(document.createElement) */
...
/* document.createElement로 요소 생성하기 */
...
btn4.addEventListener("click", () => {
  ...
  // 이것도 가능하지만 setAttribute보단 사용 빈도 낮음(안되는 속성도 있음)
  // input.type = "text";
