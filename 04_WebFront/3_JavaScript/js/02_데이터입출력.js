...
function getBoxText(){
  ...
  // test1.innerText : test1 요소에 작성도니 내용을 얻어와라
  console.log(test1.innerText)
  // 태그 빼고 출력함! br, b 태그 없이!
}
...
function confirmFn(){
  ...
  if(confirm("배경색을 변경할까요?")){ // 확인 버튼 클릭 시 
    confirmBox.style.backgroundColor="lightpink";
  }
  else{ // 취소 버튼 클릭 시
